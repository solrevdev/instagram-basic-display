...
{
    /// <summary>
    /// Represent errors that occur while calling a Instagram API and getting a specific OAuthException type exception returned
    /// </summary>
    [Serializable]
    ...
    public class InstagramOAuthException : InstagramException
    {
        ...
        public InstagramOAuthException(InstagramError error) : base(error.Message)
        {
        ...
        public InstagramOAuthException(string message, string errorType = default, int errorCode = default, int errorSubcode = default)
        ...
        public InstagramOAuthException(string message, Exception innerException)
        ...
        protected InstagramOAuthException(SerializationInfo info, StreamingContext context)
            : base(info, context)
        {
        }
    }
